...
{
    public partial class frmSalePlanTurning : Form
    {
        public frmSalePlanTurning(string Section)
        {
            Se = Section;
            ...
            dt_S = new DAL.SalePlan.DataSet_SalePlanTurning.SlSalePlanTurningDataTable();
        ...
        private void ReplicateBtn(Control Se, string Text)
        {
            ...
            uc_Month1.ShowPopUp(Se, new BLL.SalePlan.csSalePlanTurning().SlSalePlanPopUp(Text, Text));
        ...
        private DAL.SalePlan.DataSet_SalePlanTurning.SlSalePlanTurningDataTable dt_S;
        ...
        {
            BLL.SalePlan.csSalePlanTurning cs = new BLL.SalePlan.csSalePlanTurning();
        ...
        void ShowInDatagridViewSummarize()
        {
            ...
            dataGridView2.DataSource = cs.SlSalePlanTurningSummarize(lbl_Date.Text.Substring(0, 8) + "01", lbl_Date.Text.Substring(0, 8) + "31",Payazob.Properties.Settings.Default.WorkYear);
        ...
        private void toolStripButtonListView_Click_1(object sender, EventArgs e)
        {
            frmEmpty_Report f = new frmEmpty_Report("SalePlanTurning", "crsSalePlanTurning");
            (f as frmEmpty_Report).SetParam("x_", false);
            (f as frmEmpty_Report).SetParam("xPieces_", false);
            (f as frmEmpty_Report).SetParam("xCustomer_", false);
            (f as frmEmpty_Report).SetParam("xSupplier_", false);
