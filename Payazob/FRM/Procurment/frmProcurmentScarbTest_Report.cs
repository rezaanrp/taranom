...
{
    public partial class frmProcurmentScarbTest_Report : Form
    {
        public frmProcurmentScarbTest_Report()
        {
            InitializeComponent();
        ...
        private void Replicate(string message)
        {
            ...
            if (message == "گزارش قراضه ورودی به تفکیک نوع قراضه")
              r.GetReport = cs.GetReport(dt, "crsProcurmentScarbTestRP");
            else
                r.GetReport = cs.GetReport(dt, "crsProcurmentScarbTestCo");
        ...
        private void btn_Show_Click(object sender, EventArgs e)
        {
            ...
            dt = cs.SlProcurmentScarbTestRp(uc_Filter_Date1.DateFrom, uc_Filter_Date1.DateTo);
        ...
        private void printToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            dr["State"] = "گزارش قراضه ورودی به تفکیک شرکت";
            dr["Value"] = 1;
            dt.Rows.Add(dr);

            DataRow dr1 = dt.NewRow();
            dr1["State"] = "گزارش قراضه ورودی به تفکیک نوع قراضه";
            dr1["Value"] = 2;
            dt.Rows.Add(dr1);
        ...
        private void frmProcurmentScarbTest_Report_Resize(object sender, EventArgs e)
        {
            uc_ListFiled1.Visible = false;
