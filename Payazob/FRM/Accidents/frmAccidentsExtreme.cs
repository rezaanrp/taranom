...
{
    public partial class frmAccidentsExtreme : Form
    {
        public frmAccidentsExtreme()
        {
            InitializeComponent();
            ...
            dt_A = new DAL.AccidentsMinor.DataSet_AccidentsMinor.mAccidentsExtremeDataTable();
        ...
        DAL.AccidentsMinor.DataSet_AccidentsMinor.mAccidentsExtremeDataTable dt_A;
        void ShowData()
        {
            BLL.AccidentsMinor.Accidents cs = new BLL.AccidentsMinor.Accidents();
            dt_A = cs.AccidentsExtreme();
            bindingSource1.DataSource = dt_A;
            dataGridView1.DataSource = bindingSource1;
            bindingNavigator1.BindingSource = bindingSource1;
   ...
   MessageBox.Show(new BLL.AccidentsMinor.Accidents().UdAccidentsExtreme(dt_A));
   ShowData();
            }
        }
        void Generate()
