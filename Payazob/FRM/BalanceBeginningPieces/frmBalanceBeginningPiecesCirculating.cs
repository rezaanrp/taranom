...
{
    public partial class frmBalanceBeginningPiecesCirculating : Form
    {
        public frmBalanceBeginningPiecesCirculating()
        {
            InitializeComponent();
            ...
            dt_B = new BLL.BalanceBeginningPieces.csBalanceBeginningPieces().mBalanceBeginningPiecesCirculating(Properties.Settings.Default.WorkYear);
   ...
   dataGridView1.Columns[dc.ColumnName].HeaderText = css.EnToFarsiCatalog(dc.ColumnName);
        ...
        DAL.BalanceBeginningPieces.DataSet_BalanceBeginning.mBalanceBeginningPiecesCirculatingDataTable dt_B;
   ...
   MessageBox.Show(cs.UdBalanceBeginningPiecesCirculating(dt_B));

   dt_B = cs.mBalanceBeginningPiecesCirculating(Properties.Settings.Default.WorkYear);
