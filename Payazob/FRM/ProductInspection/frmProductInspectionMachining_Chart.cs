...
{
    public partial class frmProductInspectionMachining_Chart : Form
    {
        public frmProductInspectionMachining_Chart()
        {
            InitializeComponent();
            ...
            Nud_Year.Value = int.Parse(Payazob.Properties.Settings.Default.WorkYear.Substring(0, 4));
        }
        ...
        void Generate()
        {
            ...
            else if (value == "5")
            {
               ...
               // dataGridView1.Columns["xName"].HeaderText = "تعداد تولید";
              ///  dataGridView1.Columns["SumDefect"].HeaderText = "مجموع ضایعات  ";
        ...
        void Chart_1()
        {
            ...
            {
                //   MessageBox.Show(dataGridView1.SelectedRows[0].Cells["xDefectName"].Value.ToString());
        ...
        void Chart_2()
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                ...
                chart2.DataSource = dtt;
                //xDefectName
                //  chart2.Series["Series1"].BorderColor = Color.DeepSkyBlue;
        ...
        void Chart_5()
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                //////DataRow[] dr = dt_PcNbDefect.Select("Pieces = '" + dataGridView1.SelectedRows[0].Cells["Pieces"].Value.ToString() + "'");
                //////DataTable dtt = dr.CopyToDataTable<DataRow>();
                //////dtt.TableName = "dt_PcNbDefect";
                
                chart2.DataSource =  new BLL.csDefect().SlPruductInspectionDefectPcPrDefect_M(uc_Filter_Date1.DateFrom, uc_Filter_Date1.DateTo, (int)dataGridView1.SelectedRows[0].Cells["x_"].Value);
        ...
        void ShowDataGridView()
        {
            ...
            {
                BLL.csDefect cs = new BLL.csDefect();
                dt_PcNbDefect = cs.SlPruductInspectionDefectDetialsGroup_M(uc_Filter_Date1.DateFrom, uc_Filter_Date1.DateTo);
                bindingSource1.DataSource = dt_PcNbDefect;
                dataGridView1.DataSource = bindingSource1;
                bindingNavigator1.BindingSource = bindingSource1;
                Chart_4();
            ...
            {
                BLL.csDefect cs = new BLL.csDefect();
                dt_PcNbDefect = new BLL.csDefect().SlPruductInspectionDefectPcPrDefectTotal_M(uc_Filter_Date1.DateFrom, uc_Filter_Date1.DateTo);
                bindingSource1.DataSource = dt_PcNbDefect;
                dataGridView1.DataSource = bindingSource1;
                bindingNavigator1.BindingSource = bindingSource1;
                Generate();
