...
namespace Report {
    ...
    public class crsPieces : ReportClass {
    ...
    public class CachedcrsPieces : Component, ICachedReport {
        
        public CachedcrsPieces() {
        }
